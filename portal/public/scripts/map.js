...
function NA_populateTab(resources) {
    ...
    if (path_avaliable) {
        ...
        {
            document.getElementById('narrativeArcTitle').innerHTML = '<h5 id="listTitle" style="padding-top: 7px;">' + resources[0].pathwayId + '</h5><div class="btn-group"><a class="btn btn-round btn-outline-primary my-2 my-sm-0" <a href="/narrativeArc/teacher/' + resources[0].pathwayId + '" class="btn btn-round btn-outline-primary my-2 my-sm-0 viewMapButton" target="blank">View</a><button class="btn btn-round btn-outline-primary my-2 my-sm-0 viewMapButton" type="button" disabled>Generate</button>';
        }
        else
        {
            console.log('Hi');
            document.getElementById('narrativeArcTitle').innerHTML = '<h5 id="listTitle" style="padding-top: 7px;">' + resources[0].pathwayId + '</h5><div class="btn-group"><a class="btn btn-round btn-outline-primary my-2 my-sm-0" <a href="/narrativeArc/' + resources[0].pathwayId + '" class="btn btn-round btn-outline-primary my-2 my-sm-0 viewMapButton" target="blank">Start</a>';
        }
        pathwayId = resources[0].pathwayId;
    } else {
